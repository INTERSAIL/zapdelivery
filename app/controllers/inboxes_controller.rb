class InboxesController < ApplicationController
  ...
  def show
    ...
    respond_to do |format|
      ...
      format.js { render_modal(@inbox.numero_protocollo, "inboxes/inbox") }
  ...
  private
    ...
    def inbox_params
      params.require(:inbox).permit(:mittente, :numero_protocollo, :numero_pagine, :allegato, :allegato_xid, :data_ricezione)
    end
end
